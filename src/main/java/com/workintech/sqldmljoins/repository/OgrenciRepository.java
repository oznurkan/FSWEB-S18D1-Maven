...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_3 = "SELECT DISTINCT o.* \n" +
            "FROM ogrenci AS o \n" +
    ...
    String QUESTION_8 = "SELECT o.sinif, COUNT(o.sinif) FROM ogrenci as o GROUP BY o.sinif";
    @Query(value = QUESTION_8, nativeQuery = true)
    List<StudentClassCount> findStudentClassCount();


    //Her öğrencinin ad soyad karşılığında okuduğu kitap sayısını getiriniz.
    String QUESTION_9 = "SELECT o.ad, o.soyad, COUNT(k.kitapno) FROM islem as i\n" +
